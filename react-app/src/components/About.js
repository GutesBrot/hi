    ...
    return (
        <section id="about" className="bg-intro py-16 pt-[120px] relative z-0">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <p className='text-black text-sm sm:text-base lg:text-lg leading-relaxed max-w-4xl mx-auto'>
            ...
            <div className="blob-container">
                ...
                <svg 
                    ...
                    version="1.1">
                    <g transform="translate(337.5 450)">
                    ...
                    <g style={{ visibility: 'hidden' }} transform="translate(337.5 450)">
